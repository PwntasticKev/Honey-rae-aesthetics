...
export const createDemoOrg = mutation({
	...
	handler: async (ctx) => {
		...
		await ctx.db.insert("messageTemplates", {
			...
			type: "sms",
			content: "Hi {{first_name}}! Welcome to Honey Rae Aesthetics. We're excited to help you on your beauty journey. Your consultation is scheduled for {{appointment_date}} at {{appointment_time}}. See you soon!",
