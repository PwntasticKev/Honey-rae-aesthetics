...
import { useGlobalSearch, useSearchSuggestions, type SearchResult } from "@/lib/convexSearchService";
					...
					<div className="p-3 border-b border-gray-200">
						<div className="flex items-center justify-between">
							<h3 className="text-sm font-medium text-gray-900">
								{showSuggestions ? 'Recent Searches' : `Search Results (${results.length})`}
							</h3>
