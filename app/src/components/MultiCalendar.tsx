...
export function MultiCalendar({
  ...
  const handleSyncCalendars = async () => {
    ...
    try {
      ...
      const totalEvents = results.reduce(
        (sum, result) => sum + result.eventsAdded + result.eventsUpdated,
        0,
      );
  ...
  const handleDisconnectProvider = async (providerId: string) => {
    ...
    try {
      const success =
        await googleCalendarService.disconnectProvider(providerId);
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Connect your Google Calendars to get started
            </p>
          </div>
        </div>
        ...
        <Card className="text-center py-12">
          <CardContent>
            ...
            <p className="text-gray-600 mb-6">
              Add your first Google Calendar to start managing appointments
              across multiple providers.
            </p>
            <Button onClick={handleAddCalendar} data-theme-aware="true">
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Connect your calendars to start syncing
            </p>
          </div>
              ...
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  ...
                  <Badge
                    ...
                    className={
                      provider.isConnected ? "bg-green-100 text-green-800" : ""
                    }
                  >
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-medium">
                      {provider.lastSync
                        ? format(provider.lastSync, "MMM dd, h:mm a")
                        : "Never"}
                    </span>
                  </div>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Manage appointments across all providers
          </p>
        </div>
        <div className="flex items-center space-x-3">
          {syncStatus && (
                  ...
                  return (
                    ...
                    >
                      {hourEvents.map((event) => (
                        <div
                          key={event.id}
                          className={`absolute left-1 right-1 p-2 rounded text-xs cursor-pointer ${getProviderColor(
                            event.provider,
        ...
        <CardContent>
          <div className="space-y-3">
            {getEventsForDay(new Date()).map((event) => (
              ...
              >
                <div
                  className={`w-4 h-4 rounded-full ${getProviderColor(event.provider)}`}
                />
