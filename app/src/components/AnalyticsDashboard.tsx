		...
		<div className="space-y-6">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
				<Card className="glass border-pink-200/50 hover:shadow-lg transition-all duration-300">
					...
					<CardContent>
						<div className="text-2xl font-bold gradient-text">{stats.totalClients}</div>
				...
				<Card className="glass border-pink-200/50 hover:shadow-lg transition-all duration-300">
					...
					<CardContent>
						<div className="text-2xl font-bold gradient-text">{stats.appointments}</div>
						<p className="text-xs text-muted-foreground">
				...
				<Card className="glass border-pink-200/50 hover:shadow-lg transition-all duration-300">
					...
					<CardContent>
						<div className="text-2xl font-bold gradient-text">{stats.messagesSent}</div>
						<p className="text-xs text-muted-foreground">
							+8% from last week
						</p>
					</CardContent>
						...
						<div className="space-y-4">
							...
							<div className="flex items-center space-x-3">
								...
								<div className="flex-1">
									...
									<p className="text-xs text-muted-foreground">Google Review Request • 8 hours ago</p>
								</div>
							</div>
						</div>
					</CardContent>
				...
				<Card className="glass border-pink-200/50">
					...
					<CardContent>
						<div className="flex items-center space-x-2">
							...
							<div>
								<div className="text-2xl font-bold">{stats.workflowsTriggered}</div>
								<p className="text-xs text-muted-foreground">Workflows triggered</p>
							</div>
						</div>
					</CardContent>
				</Card>
