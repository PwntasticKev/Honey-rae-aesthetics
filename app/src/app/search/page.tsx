...
import { Menu, Search, Bell, LogOut, Filter, X, ArrowLeft } from "lucide-react";
            ...
            <div className="mb-6">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  {["active", "scheduled", "completed", "draft"].map(
                    (status) => (
                      <Button
                        key={status}
                        variant={
...
export default function SearchPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-rose-50 flex items-center justify-center">
