...
export default function SocialPage() {
	...
	const [posts, setPosts] = useState<SocialPost[]>([
		{
			...
			content: "Amazing results from our latest treatment! #aesthetics #transformation",
		...
		},
		{
			...
			content: "Introducing our latest anti-aging treatment. Book your consultation today!",
	...
	const [connectedPlatforms, setConnectedPlatforms] = useState<SocialPlatform[]>([
		{ _id: "1", platform: "instagram", accountName: "@honeyrae_aesthetics", isActive: true },
		{ _id: "2", platform: "facebook", accountName: "Honey Rae Aesthetics", isActive: true },
	]);

	const handleCreatePost = (newPost: Omit<SocialPost, "_id" | "createdAt" | "updatedAt">) => {
					...
					<div className="flex items-center justify-between px-6 h-16">
						<div className="flex items-center space-x-6">
							...
							<div>
								...
								<p className="text-sm text-gray-600">Schedule and manage your social media posts</p>
							</div>
						</div>
